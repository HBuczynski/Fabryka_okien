...
class Ui_clientSearchDialog(object):
    def setupUi(self, clientSearchDialog):
        ...
        clientSearchDialog.resize(924, 273)
        ...
        self.clientSearchTable.setColumnCount(7)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.clientSearchTable.setHorizontalHeaderItem(6, item)
    ...
    def retranslateUi(self, clientSearchDialog):
        ...
        item.setText(_translate("clientSearchDialog", "ID"))
        item = self.clientSearchTable.horizontalHeaderItem(1)
        item.setText(_translate("clientSearchDialog", "Adres faktury"))
        ...
        item = self.clientSearchTable.horizontalHeaderItem(6)
