...
class Ui_invoiceDialog(object):
    ...
    def retranslateUi(self, invoiceDialog):
        ...
        self.invoiceStatusComboBox.setItemText(0, _translate("invoiceDialog", "Zwrot"))
        ...
        self.invoiceStatusComboBox.setItemText(4, _translate("invoiceDialog", "Zakonczone"))
        self.invoiceStatusComboBox.setItemText(5, _translate("invoiceDialog", "Zlozone"))
