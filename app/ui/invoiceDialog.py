...
class Ui_invoiceDialog(object):
    def setupUi(self, invoiceDialog):
        ...
        self.selectClientButton.raise_()
    ...
    def retranslateUi(self, invoiceDialog):
        ...
        self.clientNameLabel.setText(_translate("invoiceDialog", "nameLabel"))
        self.clientCodeLabel.setText(_translate("invoiceDialog", "codeLabel"))
        self.clientAddressLabel.setText(_translate("invoiceDialog", "adressLabel"))
